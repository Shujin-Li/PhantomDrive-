...
static constexpr auto qt_meta_stringdata_ZN12PhantomDrive21IDrivingDataCollectorE = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_ZN12PhantomDrive21IDrivingDataCollectorE[] = {
...
Q_CONSTINIT const QMetaObject PhantomDrive::IDrivingDataCollector::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12PhantomDrive21IDrivingDataCollectorE.offsetsAndSizes,
    qt_meta_data_ZN12PhantomDrive21IDrivingDataCollectorE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12PhantomDrive21IDrivingDataCollectorE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<IDrivingDataCollector, std::true_type>,
        ...
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'dataBatchReady'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<const QList<DrivingData> &, std::false_type>
    >,
    nullptr
} };
...
void PhantomDrive::IDrivingDataCollector::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (IDrivingDataCollector::*)(const DrivingData & );
            if (_q_method_type _q_method = &IDrivingDataCollector::dataCollected; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (IDrivingDataCollector::*)(const ViolationEvent & );
            if (_q_method_type _q_method = &IDrivingDataCollector::violationDetected; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _q_method_type = void (IDrivingDataCollector::*)();
            if (_q_method_type _q_method = &IDrivingDataCollector::collectionStarted; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
        {
            using _q_method_type = void (IDrivingDataCollector::*)();
            if (_q_method_type _q_method = &IDrivingDataCollector::collectionStopped; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 3;
                return;
            }
        }
        {
            using _q_method_type = void (IDrivingDataCollector::*)(const QList<DrivingData> & );
            if (_q_method_type _q_method = &IDrivingDataCollector::dataBatchReady; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 4;
                return;
            }
        }
...
void *PhantomDrive::IDrivingDataCollector::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12PhantomDrive21IDrivingDataCollectorE.stringdata0))
