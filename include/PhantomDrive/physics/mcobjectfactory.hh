...
public:
    explicit MCSurfaceObjectData(const std::string& typeId) : MCObjectData(typeId), m_defaultCircleShape(false) {}
    void setSurfaceId(const std::string& id) { m_surfaceId = id; }
    std::string surfaceId() const { return m_surfaceId; }
    void setDefaultCircleShape(bool v) { m_defaultCircleShape = v; }
    bool defaultCircleShape() const { return m_defaultCircleShape; }
private:
    std::string m_surfaceId;
    bool m_defaultCircleShape;
};

class MCMeshObjectData : public MCObjectData {
public:
    explicit MCMeshObjectData(const std::string& typeId) : MCObjectData(typeId), m_defaultCircleShape(false) {}
    void setMeshId(const std::string& id) { m_meshId = id; }
    std::string meshId() const { return m_meshId; }
    void setDefaultCircleShape(bool v) { m_defaultCircleShape = v; }
    bool defaultCircleShape() const { return m_defaultCircleShape; }
private:
    std::string m_meshId;
