...
public:
    ...
    void setPosition(const QVector2D& position) override { m_position = position; }

    qreal getRotation() const override { return m_rotation; }
    void setRotation(qreal rotation) override { m_rotation = rotation; }
    ...
    void setMaxSpeed(qreal speed) override { m_config.maxSpeed = speed; }
